...
1. A series of error messages recording all errors found in your code (to stdout). Files will stop being created if an error is detected
2. A series of files and extension files will be created. When created, the name of the file will be printed as a signifier. The files:
